...
CREATE TABLE "Household" (
    ...
    "subtitle" TEXT,
    "trackerState" JSONB NOT NULL DEFAULT '{}',
    "shopChecks" JSONB NOT NULL DEFAULT '{}',
    "batchDate" TEXT,
    "weekOverride" JSONB NOT NULL DEFAULT '{}',
    "leftovers" JSONB NOT NULL DEFAULT '[]',
    "customRecipes" JSONB NOT NULL DEFAULT '[]',
